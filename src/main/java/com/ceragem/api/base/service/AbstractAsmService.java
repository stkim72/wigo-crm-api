...
/**
 * <pre>
 * com.ceragem.crm.common.service.AbstractAsmService
 * </pre>
 *
 * @ClassName : AbstractAsmService
 * @Description : AbstractAsmService
 * @author : 이윤성
 * @date : 2022. 5. 20.
 * @Version : 1.0
 * @Company : Copyright ⓒ wigo.CO.LTD. All Right Reserved
 */
public abstract class AbstractAsmService {
	public abstract IAsmDao getDao();

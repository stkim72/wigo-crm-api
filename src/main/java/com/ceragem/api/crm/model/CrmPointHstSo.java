...
public class CrmPointHstSo extends ApiPagination {
	 ...
	 * 검색시작일
	 */
	@Parameter(description = "검색시작일", example = "", hidden = true, required = false)
	@DateValue
	private String startDt;
	/**
	 * 검색종료일
	 */
	@Parameter(description = "검색종료일", example = "", hidden = true, required = false)
	@DateValue
	 ...
	 */
	@Parameter(description = "발행구분코드  [010 : 웰카페 체험추천 , 020 : 홈체험 추천 , 030 : 멤버십 가입 추천 , 040 : 웰카페 체험 , 050 : 홈체험 , 060 : 멤버십회원 가입 , 070 : 마케팅정보 수신동의 , 080 : 앱 다운로드 , 090 : 추가 정보 입력 , 100 : 생일 , 110 : 휴면방지 , 120 : 휴면해제 , 130 : 출석체크 , 140 : 텍스트 후기 작성 , 150 : 이미지 후기 작성 , 160 : 동영상 후기 작성 , 170 : 세라체크 , 180 : 서베이 , 190 : IoT , 901 : 구매, 902 : 구매추천, 903 : 스탬프, 904 : 쿠폰, 905 : 프로모션, 940 : 수기차감, 950 : 수기지급, 960 : 캠페인지급, 970 : 승급]", example = "001", hidden = false, required = true)
	@CodeValue(codeId = "EV100", codes = { "010", "020", "030", "040", "050", "060", "070", "080", "090", "100", "110",
			"120", "130", "140", "150", "160", "170", "180", "190", "901",
			"902",  "903", "904", "905", "940", "950", "960", "970" }, message = "[010 : 웰카페 체험추천 , 020 : 홈체험 추천 , 030 : 멤버십 가입 추천 , 040 : 웰카페 체험 , 050 : 홈체험 , 060 : 멤버십회원 가입 , 070 : 마케팅정보 수신동의 , 080 : 앱 다운로드 , 090 : 추가 정보 입력 , 100 : 생일 , 110 : 휴면방지 , 120 : 휴면해제 , 130 : 출석체크 , 140 : 텍스트 후기 작성 , 150 : 이미지 후기 작성 , 160 : 동영상 후기 작성 , 170 : 세라체크 , 180 : 서베이 , 190 : IoT , 901 : 구매, 902 : 구매추천, 903 : 스탬프, 904 : 쿠폰, 905 : 프로모션, 940 : 수기차감, 950 : 수기지급, 960 : 캠페인지급, 970 : 승급] 등록된 코드가 아닙니다. 11 ")
	@MaxByte(max = 3)

...
//		vo.setDecryptYn("Y");
	...
	public ResponseEntity<ApiVoidResultVo> saveAlliance(
			...
			@Parameter(description = "사번") @RequestParam("empNo") String empNo) throws Exception {
		EzMap vo = new EzMap();
	...
	public ResponseEntity<ApiVoidResultVo> appToken(
			...
			@Parameter(description = "OS정보") @RequestParam("osCd") String appPushOsCd) throws Exception {
		CrmCustVo vo = new CrmCustVo();
		vo.setItgCustNo(itgCustNo);

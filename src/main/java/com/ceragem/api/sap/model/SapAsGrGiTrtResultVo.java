...
/**
 * 
 * @ClassName SapAsGrGiTrtResultVo
 * @author user
 * @date 2022. 6. 20.
 * @Version 1.0
 * @description SAP 입/출고처리 결과 Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP 입/출고처리 결과 객체")
public class SapAsGrGiTrtResultVo {
	@Schema(description = "자재전표번호", example = "", hidden = false, required = true, nullable = false, maxLength = 10)
	private String mblnr;

	@Schema(description = "자재전표년도", example = "", hidden = false, required = true, nullable = false, maxLength = 4)

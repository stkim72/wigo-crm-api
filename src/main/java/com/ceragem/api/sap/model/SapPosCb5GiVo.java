...
/**
 * 
 * @ClassName SapPosCb5GiVo
 * @author 이승빈
 * @date 2022. 7. 4.
 * @Version 1.0
 * @description SAP CB5)주문 출고 승인, 취소 객체
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP CB5)주문 출고 승인, 취소 객체")
public class SapPosCb5GiVo {
	...
	@Schema(description = "SAP CB5)주문 출고 승인, 취소 ITEM", example = "", hidden = false, required = true, nullable = false)
	private List<SapPosCb5GiItemVo> items = null;

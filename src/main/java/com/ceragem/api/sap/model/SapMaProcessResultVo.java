...
/**
 * 
 * @ClassName SapMaProcessResultVo
 * @author 이승빈
 * @date 2022. 7. 12.
 * @Version 1.0
 * @description SAP 마일리지 통합 완료 처리 내역 수신 처리 결과 Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP 마일리지 통합 완료 처리 내역 수신 결과 객체")
public class SapMaProcessResultVo {

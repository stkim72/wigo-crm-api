...
/**
 * 
 * @ClassName SapPosWcfBtVo
 * @author 이승빈
 * @date 2022. 7. 1.
 * @Version 1.0
 * @description SAP POS 웰카페)점간 이동 내역 Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP POS 웰카페)점간 이동 내역 객체")
public class SapPosWcfBtVo {
	...
	@Schema(description = "SAP POS 웰카페)점간 이동 내역 ITEM", example = "", hidden = false, required = true, nullable = false)
	private List<SapPosWcfBtItemVo> items = null;

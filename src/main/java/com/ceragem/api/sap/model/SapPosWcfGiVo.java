...
/**
 * 
 * @ClassName SapPosWcfGiVo
 * @author 이승빈
 * @date 2022. 7. 4.
 * @Version 1.0
 * @description SAP POS 웰카페)주문 이고 승인, 취소
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP POS 웰카페)주문 이고 승인, 취소 객체")
public class SapPosWcfGiVo {
	...
	@Schema(description = "SAP POS 웰카페)주문 이고 승인, 취소 ITEM", example = "", hidden = false, required = true, nullable = false)
	private List<SapPosWcfGiItemVo> items = null;

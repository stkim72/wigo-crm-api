...
/**
 * 
 * @ClassName SapPntProcessResultVo
 * @author 이승빈
 * @date 2022. 6. 22.
 * @Version 1.0
 * @description SAP PNT 포인트적립/소멸 완료 처리 결과 Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP PNT 포인트적립/소멸 완료 처리 결과 객체")
public class SapPntProcessResultVo {

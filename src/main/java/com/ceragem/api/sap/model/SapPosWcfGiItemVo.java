...
/**
 * 
 * @ClassName SapPosWcfGiItemVo
 * @author 이승빈
 * @date 2022. 7. 4.
 * @Version 1.0
 * @description SAP POS 웰카페)주문 이고 승인, 취소 ITEM Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP POS 웰카페)주문 이고 승인, 취소 ITEM 객체")
public class SapPosWcfGiItemVo {

...
/**
 * 
 * @ClassName SapPosCb5GiItemVo
 * @author 이승빈
 * @date 2022. 7. 4.
 * @Version 1.0
 * @description SAP POS CB5)주문 출고 승인, 취소 ITEM Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP POS CB5)주문 출고 승인, 취소 ITEM 객체")
public class SapPosCb5GiItemVo {

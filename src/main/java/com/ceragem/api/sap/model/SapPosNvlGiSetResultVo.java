...
/**
 * 
 * @ClassName SapPosNvlGiSetResultVo
 * @author 이승빈
 * @date 2022. 7. 4.
 * @Version 1.0
 * @description SAP POS 나비엘)주문 출고 승인, 취소 결과 Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "SAP POS 나비엘)주문 출고 승인, 취소 결과 객체")
public class SapPosNvlGiSetResultVo {

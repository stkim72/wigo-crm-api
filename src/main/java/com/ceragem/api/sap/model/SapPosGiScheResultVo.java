...
/**
 * 
 * @ClassName SapPosGiScheResultVo
 * @author 이승빈
 * @date 2022. 7. 27.
 * @Version 1.0
 * @description 매장 출고 내역(매장 입고 예정) 결과 Vo
 * @Company Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
@Schema(description = "매장 출고 내역(매장 입고 예정) 결과 객체")
public class SapPosGiScheResultVo {
	...
	@Schema(description = "매장 출고 내역 ITEM", example = "[]", hidden = false, required = true, nullable = false)
	private List<SapPosGiScheResultVo> items = null;
}
